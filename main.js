...
class HelpDesc {
  ...
  onClickAddNewTask() {
    this.parentEl.insertAdjacentHTML("afterbegin", `<div class="popover">
  ...
  clickOnBody(e) {
    ...
    if (!e.target.classList.contains("done-btn") && !e.target.classList.contains("edit-btn") && !e.target.classList.contains("remove-btn")) {
      // XHR = GET desc
    ...
    if (e.target.classList.contains("done-btn") && e.target.textContent === "✔") {
    ...
    } else if (e.target.classList.contains("done-btn") && e.target.textContent === "") {
      e.target.innerText = "✔";
      const task = e.target.closest(".tasks-task");
      const shortDesc = task.querySelector(".task-text").innerText;
      const allDesc = task.querySelector(".description").innerText;
    ...
    if (e.target.classList.contains("edit-btn")) {
      ...
      document.querySelector(".popover-btn-edit").addEventListener("click", e => {
        const popover = e.target.closest(".popover");
    ...
    if (e.target.classList.contains("remove-btn")) {
      ...
      this.parentEl.insertAdjacentHTML("afterbegin", `<div class="popover popover-delete">
      ...
      document.querySelector(".popover-btn-delete").addEventListener("click", e => {
        const popover = e.target.closest(".popover");
        popover.remove();
        task.remove();
        api.deleteTicket(id);
...
const helpDesc = new HelpDesc(container);
helpDesc.bindToDOM();
;// ./src/index.js
