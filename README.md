[![Build status](https://ci.appveyor.com/api/projects/status/387oqm01tfgjj27l?svg=true)](https://ci.appveyor.com/project/SenselessObsessed/dnd)
...
При этом если одна книжка скачивается дважды, то и учитываться в объёме скачанного она должна также дважды.
